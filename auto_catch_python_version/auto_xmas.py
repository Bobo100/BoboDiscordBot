...
if __name__ == '__main__':
    ...
    broswer_origin_path = "user-data-dir=C:\\Users\\" + os.getlogin() + "\\AppData\\Local\\Microsoft\\Edge\\User Data"
    broswer_copy_path = "user-data-dir=C:\\Users\\" + os.getlogin() + "\\AppData\\Local\\Microsoft\\Edge\\User Data1"
    
    if(not os.path.isdir(broswer_copy_path)):
        shutil.copytree(broswer_origin_path, broswer_copy_path)
